...
class EbGallery {
    ...
    private function _setup_tmpl() {
        ...
        $tmpl_content = str_replace("###","@THISISASEP@",$tmpl_content);
        $tmpl_content = str_replace("#","@THISISADASH@",$tmpl_content);
        $tmpl_content = str_replace("@THISISASEP@","###",$tmpl_content);

        $template_parts = array('gallery', 'title', 'image','selectedimage');
    ...
    private function _create_html($image_dir) {
        ...
        $html = str_replace("((selectedimage))", $this->selectedimage_tmpl,$html);
        $html = str_replace("@THISISADASH@","#",$html);
        return $html;
    }
}